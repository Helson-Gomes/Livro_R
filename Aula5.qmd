...
```{r, echo=FALSE}
estados = read_sf("Files/BR_UF_2024.shp")
head(estados)
```
...
```{r, echo=FALSE}
meso = geobr::read_meso_region()
ggplot(meso) +
  geom_sf() +
  theme_void()
```

## Dados de outras linguagens
